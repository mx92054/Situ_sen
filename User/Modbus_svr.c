...
#define ADDRESS wReg[190] //当前站地址
#define FRAMETIMER 5			//帧时间间隔
#define BAUDRATE wReg[191]
#define BOOT_NUM wReg[192]
#define MSVR_CYCLE wReg[193]
...
void Modbus_init(void)
{
	...
	ulLastTick = GetCurTicks();

	MODBUS_NVIC_Configuration();
	MODBUS_Config(BAUDRATE * 100);

	sprintf(msg, "Program Initialize(station: %d, baudrate: %d", ADDRESS, BAUDRATE * 100);
